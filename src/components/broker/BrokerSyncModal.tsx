...
const DEFAULT_BROKERS: BrokerConnection[] = [
  // Global Crypto - Delta Exchange Top Priority
  {
    id: 'b-delta',
    provider: 'delta',
    name: 'Delta Exchange (India & Global F&O / Perpetuals)',
    category: 'Global Crypto',
    isConnected: true,
    apiKey: 'delta_live_fno_api_key_v2',
  ...
  },
  {
    id: 'b-kucoin',
    provider: 'kucoin',
    name: 'KuCoin Futures Pro Gateway',
    category: 'Global Crypto',
    isConnected: false,
    apiKey: 'kucoin_key',
    syncedTradesCount: 0,
  ...
  },
  {
    id: 'b-okx',
    provider: 'okx',
    name: 'OKX Multi-Asset V5 Engine',
    category: 'Global Crypto',
    isConnected: false,
    apiKey: 'okx_v5_key',
    syncedTradesCount: 0,
  ...
  },
  {
    id: 'b-aliceblue',
    provider: 'aliceblue',
    name: 'Alice Blue ANT Plus API',
    category: 'Indian Stocks / F&O',
    isConnected: false,
    apiKey: 'ant_api_secret',
    clientId: 'AB9281',
    syncedTradesCount: 0,
    autoSyncEnabled: false,
    status: 'DISCONNECTED',
  },
  {
    id: 'b-kotakneo',
    provider: 'kotakneo',
    name: 'Kotak Neo Trade Gateway',
    category: 'Indian Stocks / F&O',
    isConnected: false,
    apiKey: 'neo_consumer_key',
    clientId: 'KN9942',
    syncedTradesCount: 0,
    autoSyncEnabled: false,
    status: 'DISCONNECTED',
  },
  {
    id: 'b-shoonya',
    provider: 'shoonya',
    name: 'Finvasia Shoonya Zero-Brokerage API',
    category: 'Indian Stocks / F&O',
    isConnected: false,
    apiKey: 'shoonya_app_key',
    clientId: 'FA99120',
    syncedTradesCount: 0,
    autoSyncEnabled: false,
    status: 'DISCONNECTED',
  ...
  // Forex & Prop Firms
  {
    ...
    isConnected: true,
    webhookSecret: 'whsec_mt5_live_bridge_99420',
    syncedTradesCount: 88,
    autoSyncEnabled: true,
    status: 'CONNECTED',
    latencyMs: 18,
  },
  {
    id: 'b-ctrader',
    provider: 'ctrader',
    name: 'cTrader Open API v2',
    category: 'Forex & Prop Firm',
    isConnected: false,
    apiKey: 'ctrader_auth_token',
    syncedTradesCount: 0,
    autoSyncEnabled: false,
    status: 'DISCONNECTED',
  },
